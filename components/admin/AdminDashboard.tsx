    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div className="md:col-span-1 grid grid-cols-2 gap-2 md:flex md:flex-col md:space-y-2">
        <button
          ...
          className={`w-full flex items-center justify-center md:justify-start gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${activeTab === 'overview' ? 'bg-red-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
        >
        ...
        <button
          ...
          className={`w-full flex items-center justify-center md:justify-start gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${activeTab === 'restaurant' ? 'bg-red-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
        >
        ...
        <button
          ...
          className={`w-full flex items-center justify-center md:justify-start gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${activeTab === 'categories' ? 'bg-red-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
        >
        ...
        <button
          ...
          className={`w-full flex items-center justify-center md:justify-start gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${activeTab === 'products' ? 'bg-red-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
        >
        ...
        <button
          ...
          className={`w-full flex items-center justify-center md:justify-start gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${activeTab === 'coupons' ? 'bg-red-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
        >
